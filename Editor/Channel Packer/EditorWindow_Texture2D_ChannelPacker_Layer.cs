...
{
    [Serializable]
    public class EditorWindow_Texture2D_ChannelPacker_Layer
    {
        #region Variables
        #region Channel Packer
        private EditorWindow_Texture2D_ChannelPacker _channelPacker;
        #endregion
        #region Texture2D
        ...
        #region Constructors
        public EditorWindow_Texture2D_ChannelPacker_Layer(EditorWindow_Texture2D_ChannelPacker channelPacker)
        {
