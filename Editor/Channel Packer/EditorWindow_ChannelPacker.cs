...
{
    public class EditorWindow_ChannelPacker : EditorWindow
    {
        #region Variables
        #region GUIContent
        ...
        #endregion
        #region Layers
        [SerializeField] private List<EditorWindow_ChannelPacker_Layer> _layers;
        #endregion
        ...
        #region Menu Item
        [MenuItem("Tools/Channel Packer (Texture2D)")]
        public static void ShowEditorWindow()
        {
            EditorWindow_ChannelPacker _editorWindow = (EditorWindow_ChannelPacker)EditorWindow.GetWindow(typeof(EditorWindow_ChannelPacker));                              // Find existing Editor Window or create new one
            _editorWindow.Show();                                                                                                                                           // Show Editor Window in Unity Editor

            _editorWindow.titleContent = new GUIContent("Channel Packer");
        ...
        private void OnGUI()
        {
            ...
            if (_layers == null)
            {
                _layers = new List<EditorWindow_ChannelPacker_Layer>();
            }
            ...
            {
                _layers.Add(new EditorWindow_ChannelPacker_Layer(this));
            }
        ...
        #region Methods
        #region Layer Menu
        public void Remove(EditorWindow_ChannelPacker_Layer layer)
        {
            _layers.Remove(layer);
            this.UpdatePreview();
        }
        public void MoveUp(EditorWindow_ChannelPacker_Layer layer)
        {
        ...
        public void MoveDown(EditorWindow_ChannelPacker_Layer layer)
        {
            int _index = _layers.IndexOf(layer);
